...
resource "aws_cloudfront_origin_access_control" "frontend" {
  name                              = "family-recipes-${var.environment}-frontend-oac"
  description                       = "Origin Access Control for Family Recipes Frontend"
...
resource "aws_cloudfront_distribution" "main" {
  ...
  comment             = "Family Recipes ${var.environment} Distribution"
  ...
  tags = {
    Name = "family-recipes-${var.environment}-distribution"
  }
}
